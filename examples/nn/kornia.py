# MODIFIED FROM: https://kornia.readthedocs.io/en/latest/_modules/kornia/color/hsv.html
# MODIFIED FROM: https://kornia.readthedocs.io/en/latest/_modules/kornia/color/hsv.html
# MODIFIED FROM: https://kornia.readthedocs.io/en/latest/_modules/kornia/color/hsv.html
# MODIFIED FROM: https://kornia.readthedocs.io/en/latest/_modules/kornia/color/hsv.html
# MODIFIED FROM: https://kornia.readthedocs.io/en/latest/_modules/kornia/color/hsv.html
...
def rgb_to_hsv(image: torch.Tensor, eps: float = 1e-6, scale_h=False) -> torch.Tensor:
...
def hsv_to_rgb(image: torch.Tensor, scale_h=False) -> torch.Tensor:
...
class RgbToHsv(nn.Module):
    ...
    def __init__(self, eps: float = 1e-6, scale_h=False) -> None:
        super(RgbToHsv, self).__init__()
        self.eps = eps
        self.scale_h = scale_h

    def forward(self, image: torch.Tensor) -> torch.Tensor:
        return rgb_to_hsv(image, self.eps, scale_h=self.scale_h)
...
class HsvToRgb(nn.Module):
    ...
    def __init__(self, scale_h=False) -> None:
        super(HsvToRgb, self).__init__()
        self.scale_h = scale_h

    def forward(self, image: torch.Tensor) -> torch.Tensor:
        return hsv_to_rgb(image, scale_h=self.scale_h)